...
export default function Home() {
    ...
    const [zujian, setZujian] = useState(<Text />);
    ...
    function handleEditorChange(value, event) {
        ...
        const d1 = <H1 value={value}/>;
        const d2 =<H1 value={value}/>;
        const d3 =<H1 value={value}/>;
        const d4 =<H1 value={value}/>;
                                    ...
                                    <div className="border-t border-gray-200 dark:border-white/10 flex-auto flex -mb-2">
                                        <div className="relative flex-auto">
                                            ...
                                            <div id="container" className="absolute inset-0 w-full h-full">
                                                <Editor height="100%" width="100%" defaultLanguage="json" defaultValue="// some comment" onMount={handleEditorDidMount} 
